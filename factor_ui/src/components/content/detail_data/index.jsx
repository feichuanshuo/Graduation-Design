    ...
    render() {
        ...
        return (
            <Card
                ...
                className={"data-card"}
                extra={<SearchInput
                    onSearch={this.getDetailData}
                    onChange={(e) => {
                        this.getSearchHint(e.target.value)
                    }}
                    searchHint={searchHint}
                />}
                // bodyStyle={{minHeight: '488px'}}
            >
                {
                    JSON.stringify(detailData) === '{}' ?
                        <Empty description={"数据库暂未收录该数据"} style={{marginTop:'120px'}}/> : <Row gutter={[16, 16]}>
                            <Col span={24}>
                                <Card>
                                    <Statistic
                                        title="小区名称"
                            ...
                            <Col span={12}>
                                <div className={"detail-card"} style={{height: '260px'}}>
                                    ...
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'容积率'} value={detailData.plotRatio} range={100} width={500}
                                                  height={20} color={'#178dfb'}/>
                            ...
                            <Col span={12}>
                                <div className={"detail-card"} style={{height: '260px'}}>
                                    <h1>交通配置</h1>
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'公交站数量'} value={detailData.busStop} range={30} width={450}
                                                  height={20} color={'#178dfb'}/>
                                        <h5>{detailData.busStop}</h5>
                                    </div>
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'地铁站数量'} value={detailData.subwayStations} range={200} width={450}
                                                  height={20} color={'#178dfb'}/>
                            ...
                            <Col span={12}>
                                <div className={"detail-card"} style={{height: '260px'}}>
                                    <h1>教育与医疗</h1>
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'幼儿园数量'} value={detailData.kindergarten} range={150} width={450}
                                                  height={20} color={'#178dfb'}/>
                                        <h5>{detailData.kindergarten}</h5>
                                    </div>
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'小学数量　'} value={detailData.primarySchool} range={100} width={450}
                                                  height={20} color={'#178dfb'}/>
                                        <h5>{detailData.primarySchool}</h5>
                                    </div>
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'中学数量　'} value={detailData.middleSchool} range={100} width={450}
                                                  height={20} color={'#178dfb'}/>
                                        <h5>{detailData.middleSchool}</h5>
                                    </div>
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'医院数量　'} value={detailData.hospital} range={100} width={450}
                                                  height={20} color={'#178dfb'}/>
                            ...
                            <Col span={12}>
                                <div className={"detail-card"} style={{height: '260px'}}>
                                    <h1>购物与休闲</h1>
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'购物中心'} value={detailData.shoppingMall} range={150} width={450}
                                                  height={20} color={'#178dfb'}/>
                                        <h5>{detailData.shoppingMall}</h5>
                                    </div>
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'超市　　'} value={detailData.supermarket} range={2500} width={450}
                                                  height={20} color={'#178dfb'}/>
                                        <h5>{detailData.supermarket}</h5>
                                    </div>
                                    <div style={{display: "flex", lineHeight: '42px'}}>
                                        <BarChart tag={'公园　　'} value={detailData.park} range={50} width={450} height={20}
                                                  color={'#178dfb'}/>
